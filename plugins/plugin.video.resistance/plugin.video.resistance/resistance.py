...
'''
    lambda Add-on
    GNU General Public License @lockdown_machine
...
if action == None:
    ...
    from resources.lib.modules import control
    control.openSettings(id='script.elementum.burst')   
...
############################# mag Navigator#####################
    ...
    from resources.lib.indexers import navigator
    navigator.navigator().mag()

elif action == 'directory':
    from resources.lib.indexers import mag
    mag.indexer().get(url)

elif action == 'qdirectory':
    from resources.lib.indexers import mag
    mag.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import mag
    mag.indexer().getx(url)

elif action == 'browser':
    from resources.lib.indexers import mag
    mag.resolver().browser(url)

elif action == 'lists_play':
    from resources.lib.indexers import mag
    mag.player().play(url, content)

elif action == 'extinfo':
    from resources.lib.indexers import mag
    mag.indexer().rootextinfo()
